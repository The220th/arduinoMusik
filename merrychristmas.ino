...
// -8 - пауза 1/8
// -16 - пауза 1/16
int melody[] = { /* Ноты: https://i.ytimg.com/vi/DyDVP8fhIgI/maxresdefault.jpg */
  NOTE_G4,4,
  NOTE_C5,4, NOTE_C5,8, NOTE_D5,8, NOTE_C5,8, NOTE_B4,8,
  NOTE_A4,4, NOTE_F4,4, NOTE_A4,4,
  NOTE_D5,4, NOTE_D5,8, NOTE_E5,8, NOTE_D5,8, NOTE_C5,8,
  NOTE_B4,4, NOTE_G4,4, NOTE_B4,4,
  NOTE_E5,4, NOTE_E5,8, NOTE_F5,8, NOTE_E5,8, NOTE_D5,8,
  NOTE_C5,4, NOTE_A4,4, NOTE_G4,8, NOTE_G4,8,
  NOTE_A4,4, NOTE_D5,4, NOTE_B4,4,
  NOTE_C5,2, NOTE_G4,4,
  // repeat
  NOTE_G4,4,
  NOTE_C5,4, NOTE_C5,8, NOTE_D5,8, NOTE_C5,8, NOTE_B4,8,
  ...
  NOTE_C5,2, NOTE_G4,4,
  //
  NOTE_C5,4, NOTE_C5,4, NOTE_C5,4,
  NOTE_B4,2, NOTE_B4,4,
  NOTE_C5,4, NOTE_B4,4, NOTE_A4,4,
  NOTE_G4,2, NOTE_D5,4,
  NOTE_E5,4, NOTE_D5,4, NOTE_C5,4,
  NOTE_G5,4, NOTE_G4,4, NOTE_G4,8, NOTE_G4,8,
  NOTE_A4,4, NOTE_D5,4, NOTE_B4,4,
  NOTE_C5,2
};
